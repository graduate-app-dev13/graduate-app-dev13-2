                ...
                <div class="col-span-4 lg:col-span-3">
                    <div class="col-md-6">
                        ...
                        <select id="subject" class="form-select w-full" name="subject" required autofocus>
                            ...
                            <option value="図工" {{ request("subject") == "art_and_crafts" ? "selected" : "" }}>図工
                            </option>
                            <option value="家庭科" {{ request("subject") == "home_economics" ? "selected" : "" }}>家庭科
                            </option>
                            <option value="体育" {{ request("subject") == "physical_education" ? "selected" : "" }}>体育
                            </option>
                            <option value="生活科" {{ request("subject") == "life_skills" ? "selected" : "" }}>生活科
                            </option>
                            <option value="道徳" {{ request("subject") == "ethics" ? "selected" : "" }}>道徳</option>
                            <option value="総合" {{ request("subject") == "integrated_studies" ? "selected" : "" }}>総合
                            </option>
                            <option value="特別活動" {{ request("subject") == "special_activities" ? "selected" : "" }}>
                                特別活動
                            </option>
                            <option value="クラブ活動" {{ request("subject") == "club_activities" ? "selected" : "" }}>クラブ活動
                            </option>
                        </select>
                    </div>
                </div>
            ...
            <div class="mb-4">
                ...
                <div class="flex flex-wrap justify-between">
                    ...
                    <div class="w-full sm:w-1/3">
                        ...
                        <input type="time" name="first_choice_start_time" min="08:00" max="16:00"
                            value="08:00" class="border p-2 w-full" required autofocus />
                    </div>
                    <div class="w-full sm:w-1/3">
                        <label for="first_choice_end_time" class="block mt-2 mb-2">希望終了時間</label>
                        <input type="time" name="first_choice_end_time" min="08:00" max="16:00"
                            value="15:00" class="border p-2 w-full" required autofocus />
                    </div>
                </div>
                ...
                <div class="flex flex-wrap justify-between">
                    <div class="w-full sm:w-1/3">
                        ...
                        <input type="date" name="second_choice_date" class="border p-2 w-full" required
                            autofocus />
                    </div>
                    <div class="w-full sm:w-1/3">
                        <label for="second_choice_start_time" class="block mt-2 mb-2">希望開始時間</label>
                        <input type="time" id="timeInput" name="second_choice_start_time" min="08:00"
                            max="16:00" value="08:00" class="border p-2 w-full" required autofocus />
                    </div>
                    <div class="w-full sm:w-1/3">
                        <label for="second_choice_end_time" class="block mt-2 mb-2">希望終了時間</label>
                        <input type="time" name="second_choice_end_time" min="08:00" max="16:00"
                            value="15:00" class="border p-2 w-full" required autofocus />
                    </div>
                </div>
                ...
                <div class="flex flex-wrap justify-between">
                    <div class="w-full sm:w-1/3">
                        ...
                        <input type="date" name="third_choice_date" class="border p-2 w-full" required
                            autofocus />
                    </div>
                    <div class="w-full sm:w-1/3">
                        <label for="third_choice_start_time" class="block mt-2 mb-2">希望開始時間</label>
                        <input type="time" name="third_choice_start_time" min="08:00" max="16:00"
                            value="08:00" class="border p-2 w-full" required autofocus />
                    </div>
                    <div class="w-full sm:w-1/3">
                        <label for="third_choice_end_time" class="block mt-2 mb-2">希望終了時間</label>
                        <input type="time" name="third_choice_end_time" min="08:00" max="16:00"
                            value="15:00" class="border p-2 w-full" required autofocus />
                    </div>
                </div>
            </div>
