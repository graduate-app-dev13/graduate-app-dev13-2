...
<x-app-layout>
  ...
  <div class="container mx-auto p-4 flex justify-center items-center min-h-screen bg-gray-100">
            ...
            <form action="{{ route('inquiry.update',$inquiry->id) }}" method="POST" class="w-full sm:max-w-3xl">
                <!----------------------------------------------------------------------->
                @method('PUT')
                @csrf
                ...
                <div class="mb-4">
                    ...
                    <select name="category_id" value="{{$inquiry->category_id}}"  required>
                    ...
                    <input type="text"  name="inquiry_detail" class="border p-2 w-full sm:w-2/1" value="{{$inquiry->inquiry_detail}}"  required autofocus/>
